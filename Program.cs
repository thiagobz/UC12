...
");
                ...
                switch (opcaoPF)
                {
                    ...
                    case "2":
                        ...
                        string? arquivoSelect = Console.ReadLine();


                        using (StreamReader sr = new StreamReader(arquivoSelect))
                        {
                            string? linha;
...
");
                ...
                switch (opcaoPJ)
                {
                    case "1":
                        ...
                        Console.WriteLine($"Digite o nome da pessoa responsável: ");
